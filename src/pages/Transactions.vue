<template>
    <div class="card">
        <DataTable 
            ...
            paginator :rows="10"
            filterDisplay="menu"
            :globalFilterFields="['id', 'status', 'amount']"
        >
            <template #header>
...
export default {
    data() {
        return {
            transactions: [
                { id: 'T001', status: 'Payé', amount: 50.00, paymentMethod: 'Carte Crédit', date: new Date('2024-12-10') },
                { id: 'T002', status: 'Payé', amount: 30.00, paymentMethod: 'Argent Comptant', date: new Date('2024-12-10') },
                { id: 'T003', status: 'Impayé', amount: 30.00, paymentMethod: 'Carte Crédit', date: new Date('2024-12-10') },
                { id: 'T004', status: 'Impayé', amount: 30.00, paymentMethod: 'N/A', date: new Date('2024-12-7') },
                { id: 'T005', status: 'Payé', amount: 20.00, paymentMethod: 'Compte Client', date: new Date('2024-12-10') },
            ],
